...
<script>
	$(function(){
        ...
        //첨부파일 수 추가하기
        $(document).on('click',"#dataForm input[value=' + ']", function(){
...
<div class="container">
	<h1>자료실 글쓰기 폼</h1>
	<!-- 파일업로드시 form에 enctype을 표기해야 한다. -->
	<form method="post" action="dataWriteOk" id="dataForm" enctype="multipart/form-data">
		<ul>
			<li>제목</li>
			...
			<li><input type="submit" value="자료 올리기"/></li>
		</ul>
	</form>
</div>