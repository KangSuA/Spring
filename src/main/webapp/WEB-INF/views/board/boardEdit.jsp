...
<div class="container">
	<h1>글 수정 폼</h1>
	<form method="post" action="boardEditOk" id="boardForm">
	...
	<p style="background-color:#60f;padding:30px;">
		<a href="boardList?nowPage=${vo.nowPage}<c:if test="${vo.searchWord!=null }">&searchKey=${vo.searchKey }&searchWord=${vo.searchWord}</c:if>">리스트</a>
	</p>
</div>